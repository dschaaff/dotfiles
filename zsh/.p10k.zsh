# Generated by Powerlevel10k configuration wizard on 2020-08-26 at 08:42 PDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 9924.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*prd*'  PROD    # These values are examples that are unlikely
      '*stg*'  STG    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
